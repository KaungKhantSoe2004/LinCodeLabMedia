    ...
    <div class="container-fluid">
      ...
      <div class="">
        {{session('updateSuccess')}}
                    ...
                    @endif --}}
                    <form class="form-horizontal" action="{{route("admin#addCategory")}}" method="POST">
@csrf

                      <div class="form-group row">
                        <label for="inputName" class="col-sm-2 col-form-label">Title</label>
                        <div class="col-sm-10">
                          <input type="text" class="form-control" name="title"  placeholder="Enter Your Category Title...">
{{-- @if (session('noMatch'))
...
@endif --}}
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          ...
                          {{-- </textarea> --}}
                          <textarea  class=" form-control" name="description" placeholder="Enter Your Category" id="" cols="30" rows="10"></textarea>
                          @error('description')
                          <div class=" text-danger">
                           {{$message}}
                          </div>
